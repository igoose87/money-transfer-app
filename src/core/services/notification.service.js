 ...
 * It can be used to display messages with different types 
 * (success, error) and manage the notification timeout.
 */
export class NotificationService {
   ...
   * @param {('success'|'error')} message  - The type of the notification,
