/**
 *  StorageService is a class that provides an interface 
 *  for working with localStorage in a more convenient way
 */
export class StorageService{
  ...
  /**
   * Removes an item from localStorage by provided key.
