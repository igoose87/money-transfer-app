...
class RQuery {
	 ...
	 * If not provided, the method returns the current value.
	 * @return {string|RQuery} - If newValue is provided, returns the RQuery instance. 
	 * Otherwise, returns the current value of the input document.
	 */
	value(newValue){
