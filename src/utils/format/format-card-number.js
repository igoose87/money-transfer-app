...
/*
 Удаляет все пробелы из номера карты и разбивает его на группы из 4ех цифр с помощью регулярного выражения /.{1,4}/g.
 Затем функция объеденяет эти группы в одну строку с пробелами между ними, используя метод join()
*/
